...
One image worth thousand words. What have we, programmers, been doing all those years? From [Successful Projects--What We Really Know](http://www.planningplanet.com/blog/successful-projects-what-we-really-know){:target="_blank"}
...
Here is rule of thumb that I've have been promoting for years. A team should have 6-8 people. Ten is already too much. From [Why the two pizza team rule is the name of the game at Calcey](https://www.calcey.com/blog/why-the-two-pizza-team-rule-is-the-name-game-at-calcey/){:target="_blank"}
...
## How to handle non-technical customers and managers
...
> The user interface that takes about 10% of the work, and then 90% of the programming work is under the covers. That’s not the secret. The secret is that People Who Aren’t Programmers Do Not Understand This.
