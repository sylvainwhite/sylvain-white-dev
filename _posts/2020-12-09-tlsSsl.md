...
* Here are the **simplified** steps the browser follows to validate the certificate
    ...
    1. First, we see the certificate has two parts:
        * **Data**
        * **Signature Algorithm**
    2. The browser computes the hash of the **Data** part of the certificate
    3. The browser checks if the current time is between the 'Not Before' and 'Not After' dates 
    4. The browser looks for the public key of the issuer who signed the certificate
    ...
    8. Once the browser gets the public key, it decrypts the **Signature Algorithm** part 
    9. Finally, the certificate is valid if the value of step 8 matches the value of the hash value of step 3

* Here is a detailed explantion of step 6 above
